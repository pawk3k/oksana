...
var FieldValueOptions = /** @class */ (function () {
    ...
    FieldValueOptions.fromSnapshotOptions = function (options, timestampsInSnapshots) {
        switch (options.serverTimestamps) {
            case 'estimate':
                return new FieldValueOptions(1 /* Estimate */, timestampsInSnapshots);
            case 'previous':
                return new FieldValueOptions(2 /* Previous */, timestampsInSnapshots);
            case 'none': // Fall-through intended.
            case undefined:
                return new FieldValueOptions(0 /* Default */, timestampsInSnapshots);
            default:
...
var NullValue = /** @class */ (function (_super) {
    ...
    NullValue.prototype.approximateByteSize = function () {
        return 4;
    };
...
var BooleanValue = /** @class */ (function (_super) {
    ...
    function BooleanValue(internalValue) {
        ...
        _this.typeOrder = 1 /* BooleanValue */;
        return _this;
    }
    ...
    BooleanValue.prototype.approximateByteSize = function () {
        return 4;
    };
...
var NumberValue = /** @class */ (function (_super) {
    ...
    NumberValue.prototype.approximateByteSize = function () {
        return 8;
    };
    return NumberValue;
}(FieldValue));
...
var StringValue = /** @class */ (function (_super) {
    ...
    StringValue.prototype.approximateByteSize = function () {
...
var TimestampValue = /** @class */ (function (_super) {
    ...
    function TimestampValue(internalValue) {
        var _this = _super.call(this) || this;
        _this.internalValue = internalValue;
        _this.typeOrder = 3 /* TimestampValue */;
        return _this;
    }
    ...
    TimestampValue.prototype.approximateByteSize = function () {
...
var ServerTimestampValue = /** @class */ (function (_super) {
    ...
    ServerTimestampValue.prototype.value = function (options) {
        if (options &&
            options.serverTimestampBehavior === 1 /* Estimate */) {
            return new TimestampValue(this.localWriteTime).value(options);
        }
        else if (options &&
            options.serverTimestampBehavior === 2 /* Previous */) {
    ...
    ServerTimestampValue.prototype.approximateByteSize = function () {
        return (
        /* localWriteTime */ 16 +
...
var BlobValue = /** @class */ (function (_super) {
    ...
    BlobValue.prototype.approximateByteSize = function () {
...
var RefValue = /** @class */ (function (_super) {
    ...
    RefValue.prototype.approximateByteSize = function () {
...
var GeoPointValue = /** @class */ (function (_super) {
    ...
    function GeoPointValue(internalValue) {
        var _this = _super.call(this) || this;
        _this.internalValue = internalValue;
        _this.typeOrder = 7 /* GeoPointValue */;
        return _this;
    }
    ...
    GeoPointValue.prototype.approximateByteSize = function () {
...
var ObjectValue = /** @class */ (function (_super) {
    ...
    ObjectValue.prototype.approximateByteSize = function () {
        var size = 0;
        this.internalValue.inorderTraversal(function (key, val) {
...
var ObjectValueBuilder = /** @class */ (function () {
    function ObjectValueBuilder(internalValue) {
    ...
    ObjectValueBuilder.prototype.set = function (path, value) {
        ...
        var childName = path.firstSegment();
        if (path.length === 1) {
            this.internalValue = this.internalValue.insert(childName, value);
        }
        else {
            // nested field
            var child = this.internalValue.get(childName);
            var obj = void 0;
        ...
        if (path.length === 1) {
            ...
            if (child instanceof ObjectValue) {
                var newChild = child
                    ...
                    .build();
                this.internalValue = this.internalValue.insert(path.firstSegment(), newChild);
            }
        }
        return this;
    };
...
var ArrayValue = /** @class */ (function (_super) {
    ...
    ArrayValue.prototype.approximateByteSize = function () {
        return this.internalValue.reduce(function (totalSize, value) { return totalSize + value.approximateByteSize(); }, 0);
    };
...
var Document = /** @class */ (function (_super) {
    ...
    Document.prototype.data = function () {
        var _this = this;
        if (!this.objectValue) {
            var result_1 = ObjectValue.newBuilder();
            forEach(this.proto.fields || {}, function (key, value) {
                result_1.set(new FieldPath([key]), _this.converter(value));
            });
            this.objectValue = result_1.build();
            ...
            promises.push(documentBuffer.getEntries(txn, updatedKeys).next(function (existingDocs) {
                remoteEvent.documentUpdates.forEach(function (key, doc) {
                    ...
                    if (doc instanceof NoDocument &&
                        ...
                        debug(LOG_TAG, 'Ignoring outdated watch update for ', key, '. Current version:', existingDoc.version, ' Watch version:', doc.version);
                    }
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            if (err.code === Code.FAILED_PRECONDITION &&
                ...
                debug(LOG_TAG, 'Unexpectedly lost primary lease');
            }
            else {
                throw err;
            }
...
var MutationMetadata = /** @class */ (function () {
    ...
    MutationMetadata.fromWebStorageEntry = function (user, batchId, value) {
        ...
        if (validData) {
            ...
            error(LOG_TAG$1, "Failed to parse mutation state for ID '" + batchId + "': " + value);
            return null;
        }
    };
...
var QueryTargetMetadata = /** @class */ (function () {
    ...
    QueryTargetMetadata.fromWebStorageEntry = function (targetId, value) {
        ...
        if (validData) {
            ...
            error(LOG_TAG$1, "Failed to parse target state for ID '" + targetId + "': " + value);
            return null;
        }
    };
...
var RemoteClientState = /** @class */ (function () {
    ...
    RemoteClientState.fromWebStorageEntry = function (clientId, value) {
        ...
        if (validData) {
            ...
            error(LOG_TAG$1, "Failed to parse client data for instance '" + clientId + "': " + value);
            return null;
        }
    };
...
var SharedOnlineState = /** @class */ (function () {
    ...
    SharedOnlineState.fromWebStorageEntry = function (value) {
        ...
        if (validData) {
            ...
            error(LOG_TAG$1, "Failed to parse online state: " + value);
            return null;
        }
    };
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_a) {
                if (mutationBatch.user.uid !== this.currentUser.uid) {
                    debug(LOG_TAG$1, "Ignoring mutation for non-active user " + mutationBatch.user.uid);
                    return [2 /*return*/];
                }
...
function fromWebStorageSequenceNumber(seqString) {
    ...
    if (seqString != null) {
        try {
            ...
            error(LOG_TAG$1, 'Failed to read sequence number from WebStorage', e);
        }
    }
...
var ExponentialBackoff = /** @class */ (function () {
    ...
    ExponentialBackoff.prototype.backoffAndRun = function (op) {
        ...
        if (this.currentBaseMs > 0) {
            debug(LOG_TAG$3, "Backing off for " + remainingDelayMs + " ms " +
...
var PersistentStream = /** @class */ (function () {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert(finalState === 3 /* Error */ || isNullOrUndefined(error$1), "Can't provide an error when not in an error state.");
    ...
    PersistentStream.prototype.handleStreamClose = function (error) {
        ...
        debug(LOG_TAG$4, "close with error: " + error);
        this.stream = null;
        ...
        return function (fn) {
            _this.queue.enqueueAndForget(function () {
                if (_this.closeCount === startCloseCount) {
                    ...
                    debug(LOG_TAG$4, 'stream callback skipped by getCloseGuardedDispatcher.');
                    return Promise.resolve();
                }
            });
        };
...
var WatchChangeAggregator = /** @class */ (function () {
    ...
    WatchChangeAggregator.prototype.isActiveTarget = function (targetId) {
        ...
        if (!targetActive) {
            debug(LOG_TAG$6, 'Detected inactive target', targetId);
        }
        return targetActive;
    };
    /**
...
var RemoteStore = /** @class */ (function () {
    ...
    RemoteStore.prototype.onWatchStreamOpen = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib.__generator(this, function (_a) {
                forEachNumber(this.listenTargets, function (targetId, targetData) {
    ...
    RemoteStore.prototype.raiseWatchSnapshot = function (snapshotVersion) {
        ...
        forEachNumber(remoteEvent.targetChanges, function (targetId, change) {
            if (change.resumeToken.approximateByteSize() > 0) {
                var targetData = _this.listenTargets[targetId];
                // A watched target might have been removed already.
                if (targetData) {
                    _this.listenTargets[targetId] = targetData.withResumeToken(change.resumeToken, snapshotVersion);
                }
            }
        });
        ...
        remoteEvent.targetMismatches.forEach(function (targetId) {
            ...
            // state.
            _this.listenTargets[targetId] = targetData.withResumeToken(ByteString.EMPTY_BYTE_STRING, targetData.snapshotVersion);
...
var SyncEngine = /** @class */ (function () {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        queries = this.queriesByTarget[queryView.targetId];
                        if (queries.length > 1) {
                            this.queriesByTarget[queryView.targetId] = queries.filter(function (q) { return !q.isEqual(query); });
                ...
                switch (_a.label) {
                    case 0:
                        if (!this.remoteStore.canUseNetwork()) {
                            debug(LOG_TAG$8, 'The network is disabled. The task returned by ' +
    ...
    SyncEngine.prototype.removeAndCleanupTarget = function (targetId, error) {
        ...
        for (var _i = 0, _a = this.queriesByTarget[targetId]; _i < _a.length; _i++) {
            var query = _a[_i];
            this.queryViewsByQuery.delete(query);
            if (error) {
    ...
    SyncEngine.prototype.trackLimboChange = function (limboChange) {
        ...
        if (!this.limboTargetsByKey.get(key)) {
            ...
            this.remoteStore.listen(new TargetData(query.toTarget(), limboTargetId, 2 /* LimboResolution */, ListenSequence.INVALID));
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        activeTargets_1 = [];
                        p_1 = Promise.resolve();
                        forEachNumber(this.queriesByTarget, function (targetId, _) {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        targetData = void 0;
                        queries = this.queriesByTarget[targetId];
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!this.queriesByTarget[targetId]) return [3 /*break*/, 7];
                        _a = state;
                        switch (_a) {
                            ...
                            return tslib.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!this_1.queriesByTarget[targetId]) {
    ...
    SyncEngine.prototype.getRemoteKeysForTarget = function (targetId) {
        ...
        if (limboResolution && limboResolution.receivedDocument) {
            ...
            var queries = this.queriesByTarget[targetId];
            if (!queries) {
                return keySet;
            }
...
var FirestoreClient = /** @class */ (function () {
    ...
    FirestoreClient.prototype.initializeRest = function (user) {
        var _this = this;
        debug(LOG_TAG$9, 'Initializing. user=', user.uid);
    ...
    FirestoreClient.prototype.handleCredentialChange = function (user) {
        ...
        debug(LOG_TAG$9, 'Credential Changed. Current user: ' + user.uid);
...
var Blob = /** @class */ (function () {
    ...
    Blob.prototype.toUint8Array = function () {
        ...
        assertUint8ArrayAvailable();
        var buffer = uint8ArrayFromBinaryString(this._binaryString);
        return buffer;
    };
    ...
    Blob.prototype._approximateByteSize = function () {
...
var UserDataConverter = /** @class */ (function () {
     ...
     */
    UserDataConverter.prototype.parseQueryValue = function (methodName, input, allowArrays) {
...
var DocumentSnapshot = /** @class */ (function () {
    ...
    DocumentSnapshot.prototype.toJSObject = function (data, options) {
        var _this = this;
        var result = {};
        data.forEach(function (key, value) {
            result[key] = _this.toJSValue(value, options);
        });
        return result;
    };
    DocumentSnapshot.prototype.toJSValue = function (value, options) {
        if (value instanceof ObjectValue) {
    ...
    DocumentSnapshot.prototype.toJSArray = function (data, options) {
        var _this = this;
        return data.internalValue.map(function (value) {
            return _this.toJSValue(value, options);
        });
    };
...
var JsonProtoSerializer = /** @class */ (function () {
    ...
    JsonProtoSerializer.prototype.fromFields = function (object) {
        ...
        var map = object;
        var result = ObjectValue.newBuilder();
        forEach(map, function (key, value) {
            result.set(new FieldPath([key]), _this.fromValue(value));
        });
        return result.build();
    };
    ...
    JsonProtoSerializer.prototype.toQueryTarget = function (target) {
        ...
        var limit = this.toInt32Value(target.limit);
        if (limit !== null) {
...
var GrpcConnection = /** @class */ (function () {
    ...
    GrpcConnection.prototype.ensureActiveStub = function () {
        if (!this.cachedStub) {
            debug(LOG_TAG$a, 'Creating Firestore stub.');
    ...
    GrpcConnection.prototype.invokeRPC = function (rpcName, request, token) {
        ...
        return nodePromise(function (callback) {
            debug(LOG_TAG$a, "RPC '" + rpcName + "' invoked with request:", request);
            return stub[rpcName](request, metadata, function (grpcError, value) {
                if (grpcError) {
                    debug(LOG_TAG$a, "RPC '" + rpcName + "' failed with error:", grpcError);
                    callback(new FirestoreError(mapCodeFromRpcCode(grpcError.code), grpcError.message));
                }
                else {
                    debug(LOG_TAG$a, "RPC '" + rpcName + "' completed with response:", value);
    ...
    GrpcConnection.prototype.invokeStreamingRPC = function (rpcName, request, token) {
        ...
        debug(LOG_TAG$a, "RPC '" + rpcName + "' invoked (streaming) with request:", request);
        var stub = this.ensureActiveStub();
        var metadata = createMetadata(this.databaseInfo, token);
        var stream = stub[rpcName](request, metadata);
        stream.on('data', function (response) {
            debug(LOG_TAG$a, "RPC " + rpcName + " received result:", response);
            results.push(response);
        });
        stream.on('end', function () {
            debug(LOG_TAG$a, "RPC '" + rpcName + "' completed.");
    ...
    GrpcConnection.prototype.openStream = function (rpcName, token) {
        ...
        var stream = new StreamBridge({
            sendFn: function (msg) {
                if (!closed) {
                    debug(LOG_TAG$a, 'GRPC stream sending:', msg);
                    try {
                    ...
                    debug(LOG_TAG$a, 'Not sending because gRPC stream is closed:', msg);
                }
            },
            closeFn: function () {
                debug(LOG_TAG$a, 'GRPC stream closed locally via close().');
                close();
            }
        });
        grpcStream.on('data', function (msg) {
            if (!closed) {
                debug(LOG_TAG$a, 'GRPC stream received:', msg);
                stream.callOnMessage(msg);
            }
        });
        grpcStream.on('end', function () {
            debug(LOG_TAG$a, 'GRPC stream ended.');
            close();
        });
        grpcStream.on('error', function (grpcError) {
            debug(LOG_TAG$a, 'GRPC stream error. Code:', grpcError.code, 'Message:', grpcError.message);
            var code = mapCodeFromRpcCode(grpcError.code);
            close(new FirestoreError(code, grpcError.message));
        });
        debug(LOG_TAG$a, 'Opening GRPC stream');
